...
class MasterServiceSupervisorConfig {
   public:
    ...
    MasterServiceSupervisorConfig(const MasterConfig& config) {
        ...
        enable_group_ttl = config.enable_group_ttl;
...
class MasterServiceConfigBuilder {
   ...
   public:
    ...
    MasterServiceConfigBuilder& set_enable_group_ttl(bool enable) {
        enable_group_ttl_ = enable;
        return *this;
    }
...
inline MasterServiceConfig MasterServiceConfigBuilder::build() const {
    ...
    config.enable_group_ttl = enable_group_ttl_;
...
struct InProcMasterConfig {
    ...
    std::optional<bool> enable_group_ttl;
...
class InProcMasterConfigBuilder {
   private:
    ...
    std::optional<bool> enable_group_ttl_ = std::nullopt;
   ...
   public:
    ...
    InProcMasterConfigBuilder& set_enable_group_ttl(bool enable) {
        enable_group_ttl_ = enable;
        return *this;
    }
